        ...
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="feature-card bg-slate-800 p-8 rounded-2xl border border-slate-700 shadow-xl">
              ...
              <h3 className="text-xl font-bold mb-3">Real-Time WebSocket Engine</h3>
              <p className="text-slate-400">Powered by Go's high-throughput goroutines, messages are broadcast instantly without blocking HTTP overhead.</p>
            </div>
            ...
            <div className="feature-card bg-slate-800 p-8 rounded-2xl border border-slate-700 shadow-xl">
              ...
              <h3 className="text-xl font-bold mb-3">AI Smart Drafts</h3>
              <p className="text-slate-400">Google Gemini contextually analyzes the chat history and automatically stages suggested replies for agents to approve.</p>
            </div>
            ...
            <div className="feature-card bg-slate-800 p-8 rounded-2xl border border-slate-700 shadow-xl">
              ...
              <h3 className="text-xl font-bold mb-3">FOSS Infrastructure</h3>
              <p className="text-slate-400">Completely open-source backing. Uses PostgreSQL for live data and Cloudflare R2 for zero-cost cold storage archiving.</p>
            </div>
          </div>
        </div>
      </section>
